...
values
  ('dia-12', 12, '2026-07-14', 'Segunda',
   'Como reverter a objeção ''tá caro'' sem parecer desesperada', 'objecao',
   'Três scripts testados para transformar resistência de preço em urgência de compra.',
   null, null, true, 12),

  ('dia-11', 11, '2026-07-11', 'Quinta',
   'Análise real: do ''não tenho dinheiro'' ao fechamento', 'analise',
